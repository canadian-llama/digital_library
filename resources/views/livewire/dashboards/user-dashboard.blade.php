<div x-data="{ 
    ...
    <div class="flex flex-col w-64 bg-gray-900 text-white h-full">
        ...
        <div class="flex items-center p-4">
            <svg class="w-8 h-8 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path
                    d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5H18a3.75 3.75 0 0 0 1.332-7.257 3 3 0 0 0-3.758-3.848A5.25 5.25 0 0 0 4.5 6.75 4.5 4.5 0 0 0 2.25 15Z" />
            </svg>
    ...
    <!-- Main Content -->
    <div class="flex-1 p-6 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200">
        <div x-show="selectedTab === 'dashboard'" x-cloak role="tabpanel">
            <livewire:helpers.user-dashboard>
        </div>
        <div x-show="selectedTab === 'upload'" x-cloak role="tabpanel">
            <livewire:create-book>
        </div>
        <div x-show="selectedTab === 'view-books'" x-cloak role="tabpanel">
            <livewire:view-book>
        </div>
        <div x-show="selectedTab === 'notifications'" x-cloak role="tabpanel">
            <livewire:helpers.notifications>
        </div>
        <div x-show="selectedTab === 'settings'" x-cloak role="tabpanel">
            <livewire:helpers.settings>
        </div>
        <div x-show="selectedTab === 'profile'" x-cloak role="tabpanel">
